...
if ($tabla=="zapatoshombre") 
{
  $SELECT = "SELECT * FROM ZapatosHombre";
  echo '<br><h1 class="display-3" align="center">Zapatos Hombre</h1>';
}
    
else if ($tabla=="zapatosmujer") 
{
  $SELECT = "SELECT * FROM zapatosmujer";
  echo '<br><h1 class="display-3" align="center">Zapatos Mujer</h1>';
}
    
else if ($tabla=="zapatosninonina") 
{
  $SELECT = "SELECT * FROM zapatosninonina";
  echo '<br><h1 class="display-3" align="center">Zapatos Niño y Niña</h1>';
}
