...
$tabla=$_GET['tabla'];
    ...
    if ($tabla=="joyeriahombre") 
    {
      $SELECT = "SELECT * FROM joyeriahombre";
      echo '<br><h1 class="display-3" align="center">Joyeria Hombre</h1>';
    }
    
    else if ($tabla=="joyeriamujer") 
    {
      $SELECT = "SELECT * FROM JoyeriaMujer";
      echo '<br><h1 class="display-3" align="center">Joyeria Mujer</h1>';
    }
    
    else if ($tabla=="joyerianinonina") 
    {
      $SELECT = "SELECT * FROM JoyeriaNinoNina";
      echo '<br><h1 class="display-3" align="center">Joyeria Niño y Niña</h1>';
    }
