...
if ($tabla=="ropahombre") 
{
  $SELECT = "SELECT * FROM RopaHombre";
  echo '<br><h1 class="display-3" align="center">Ropa Hombre</h1>';
}

else if ($tabla=="ropamujer") 
{
  $SELECT = "SELECT * FROM ropamujer";
  echo '<br><h1 class="display-3" align="center">Ropa Mujer</h1>';
}

else if ($tabla=="ropaninonina") 
{
  $SELECT = "SELECT * FROM ropaninonina";
  echo '<br><h1 class="display-3" align="center">Ropa Niño y Niña</h1>';
}
...
echo '<tr>';
    ...
    {   
        ...
        ?>
        <td><a href="../agregarcarrito.php?tabla=<?php echo $tabla?>&&id=<?php echo ($array[$i][0])?>&&idcliente=<?php echo $id ?>"><button type="button" class="btn btn-success">Agregar al carrito</button></td>
